...
**不是 Vibe Coding，而是协作范式**：Vibe Coding 探索的是提示词、记忆与 Agent 能力的上限——那是工具侧的问题，不是我的重点。我在探索的是：**在工具既定的情况下，人与工具协作的上限**。无论 Agent 更强还是更弱、有上下文还是无上下文，协作的范式都应当成立——容易出问题的环节、需要规范的环节、必须由人决策的环节，不会因为换一个模型而消失。以人为本，工具只是变量；我选择基础设施方向作为实验场，是因为它足够大、足够真实，无法靠提示词技巧蒙混过关。
