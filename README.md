...
**我的立场**：AI 是我日常工程中的正式协作者，使用范围覆盖设计、编码、测试、文档与复盘——这不是需要隐藏的辅助，而是我在研究的工程方法。原则是：**人负责决策与质量，AI 负责执行与探索**；所有产出都经过人的审查、测试与门禁。我的项目与开源经历，就是这个方法的验证场。

**不是 Vibe Coding，而是协作范式**：我不是因为追逐 Vibe Coding 才选择 AI 基础设施——基础设施一直是我的主业。在 Kubernetes 控制面工程中，我遇到了大量真实而棘手的问题（调度、配额、可观测、长期演进）；AI 浪潮让这些问题有了新的解法，也带来了新的问题。我选择站在浪潮上激流勇进，探索人与 AI 协作的范式。这个范式是抽离的：它不依赖基础设施，也不依赖任何特定模型——换一个 Agent、换一个模型、甚至换一个领域，协作中需要规范的环节、需要人决策的环节、容易出问题的环节都依然存在。Vibe Coding 探索的是提示词、记忆与 Agent 能力的上限，那是工具侧的问题；我探索的是在工具既定的情况下，人与工具协作的上限。以人为本，工具只是变量。

**为什么这值得做**：让 AI 生成代码本身并不稀奇——真正的分水岭在于：如何与 AI 协作维护一个长期演进的复杂项目（设计决策、变更追溯、质量门禁、文档同步）；如何与 AI 协作参与开源社区的治理与贡献（披露、边界、信任）；如何用 AI 高质量地建设自己的项目，让它达到一定规模、持续扩展、便于协作与外部参与。这些才是 AI 时代工程能力的真正分水岭。

**研究方向**（我在长期探索的三个命题）

1. **能力成长的同步律**：当 AI 让产出速度指数级提升时，人的能力如何同步成长、而不是被替代？无论工具如何更替，个人成长曲线与 AI 生产力曲线都应形成健康的共振，而不是此消彼长——这是协作范式成立的前提。

2. **大工程的信任与边界**：在大型项目与关键场景中，AI 参与的边界如何划定？哪些决策必须由人承担、哪些可以交给 AI？信任如何建立（披露、审查、证据链）、又如何验证（测试、门禁、回滚）？目标是让 AI 在大型工程中持续运作，持续产出可交付、可维护、可持续演进的结果——规范化的目的不是限制 AI，而是让协作可预期、可审计。

3. **协作的经济性与社区责任**：token 与时间成本如何控制，让 AI 协作可持续？在开源社区中使用 AI，人如何承担边界监管责任（披露、合规、质量把关）？单个 Agent 的风险（误解意图、越权操作、状态污染）如何识别、隔离与恢复？权限最小化、可观测、可回滚，是 AI 时代的工程纪律。
