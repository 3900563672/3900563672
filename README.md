...
1. **能力成长的同步律**：当 AI 让产出速度指数级提升时，人的能力如何同步成长、而不是被替代？"我能做什么"与"AI 能做什么"的边界每年都在移动——我想研究的是：如何让 AI 成为能力放大器而非替代品，让个人成长曲线与 AI 生产力曲线形成健康的共振，而不是此消彼长。

2. **大工程的信任与边界**：在大型项目与关键场景中，AI 参与的边界如何划定？哪些决策必须由人承担、哪些可以交给 AI？信任如何建立（披露、审查、证据链）、又如何验证（测试、门禁、回滚）？规范化的目的不是限制 AI，而是让协作可预期、可审计、可长期演进。

3. **协作的经济性与风险韧性**：高质量协作的代价是 token 与时间的消耗——如何把成本降下来，让 AI 协作可持续？同时，单个 Agent 的风险（误解意图、越权操作、状态污染）如何识别、隔离与恢复？权限最小化、可观测、可回滚，是 AI 时代的工程纪律。
